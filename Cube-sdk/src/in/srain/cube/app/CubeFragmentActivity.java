...
public abstract class CubeFragmentActivity extends FragmentActivity {
    ...
    public void pushFragmentToBackStackWithTag(Class<?> cls, Object data,String tag) {
        FragmentParam param = new FragmentParam();
        param.cls = cls;
        param.data = data;
        param.tag = tag;
    ...
    protected String getFragmentTag(FragmentParam param) {
        if (param.tag != null)return param.tag;
    ...
    private void goToThisFragment(FragmentParam param) {
        ...
        try {
            ...
            if (mCurrentFragment != null && mCurrentFragment != fragment) {
                mCurrentFragment.animationWithOpenFragment(ft, fragment);
            }
//
            if (fragment.isAdded()) {
                if (DEBUG) {
    ...
    public void goToFragment(Class<?> cls, Object data) {
        ...
        /**
         * 如果这个地方没有获取到fragment怎么办？
         * 立即从栈中弹出这个fragment,弹出之后怎么办
         */
    ...
    {
        WeakReference<CubeFragmentActivity> weakReference;
        public MyRun(CubeFragmentActivity cubeFragmentActivity)
        {
            weakReference = new WeakReference<CubeFragmentActivity>(cubeFragmentActivity);
        }
        @Override
        public void run() {

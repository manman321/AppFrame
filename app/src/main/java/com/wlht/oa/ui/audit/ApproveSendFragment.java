...
public class ApproveSendFragment extends BaseFragment {
    ...
    protected View createView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_audit_send,null, false);
    }
    ...
    protected void initRecyclerView() {
        ...
        mAdapter.onDataChangedListener = new ApproveAdapter.OnDataChangedListener() {
            ...
            public void onDataChanged(ArrayList<Approve> data) {
                getContext().Bus.post(new Event(ApproveSendFragment.class,data));
            }
        };
    }

...
public class AppConfig {
    ...
    public static String APP_PATH = String.format("%s/mlz", ROOT_PATH);
    public static String CAMERA_PATH = String.format("%s/DCIM/Camera/", APP_PATH);

    // 默认存放图片的路径
    public final static String DEFAULT_SAVE_IMAGE_PATH =
            String.format("%s/image/",APP_PATH);

    public final static String DEFAULT_SHARE_IMAGE = String.format("%sic_launcher.png",DEFAULT_SAVE_IMAGE_PATH);

    public final static String DEFAULT_SHARE_BAG = String.format("%smmexport.jpg",DEFAULT_SAVE_IMAGE_PATH);
...
//            + File.separator + "osc_img" + File.separator;
    ...
    // 默认存放文件下载的路径
    public final static String DEFAULT_SAVE_FILE_PATH = String.format("%s/download/",APP_PATH);
//            Environment
//            .getExternalStorageDirectory()
//            + File.separator
//            + "mlz"

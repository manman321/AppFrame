...
//    public static void showDeliverActivity(Context context,String orderCode)
//    {
//        showWebActivity(context, "物流信息", String.format("http://m.zjs.com.cn/search.jspx?q=%s", orderCode));
//    }

//    public static void showWebActivity(Context context,String title,String url)
//    {
//        Intent intent = new Intent(context, SlideWebActivity.class);
//        intent.putExtra("title",title);
//        intent.putExtra("url",url);
//        context.startActivity(intent);
//    }
//
//    public static void showWebActivity(Context context,String title,String url,String homeFlowId)
//    {
//        Intent intent = new Intent(context, WebActivity.class);
//        intent.putExtra("title",title);
//        intent.putExtra("url",url);
//        intent.putExtra("homeFlowId",homeFlowId);
//        context.startActivity(intent);
//    }
//
//
//    public static void showActivityFillFragment(Context context,Class clazz)
//    {
...
//    }
//
//    public static void showActivityFillFragmentWithData(Context context,Class clazz,Serializable data)
//    {
//        Intent intent = new Intent(context, EmptyActivity.class);
//        intent.putExtra("clazz",clazz);
...
//    public static boolean loginFilter()
//    {
...
//    public static void notifyCartNoChanged(final Context context,int no)
//    {
//        AppContext.getInstance().setCartNo(String.format("%d", no));
//        LocalBroadcastManager.getInstance(context).sendBroadcast(new Intent(Constants.INTENT_ACTION_CART_NO_CHANGED));
//    }

//    public static void notifyCartNoChanged(final Context context)
//    {
//        CartRequestData.listCart(new RequestFinishHandler<ResultCart<ArrayList<CartItem>>>() {
//            @Override
//            public void onRequestFinish(ResultCart<ArrayList<CartItem>> data) {
//                if (data.OK()) {
//                    String no = String.format("%d", data.getCnt());
//                    AppContext.getInstance().setCartNo(no);
//                    LocalBroadcastManager.getInstance(context).sendBroadcast(new Intent(Constants.INTENT_ACTION_CART_NO_CHANGED));
//                }
//            }
//        });
...
//
//
//    public static void notifyBagCartNoChanged(final Context context,int no)
//    {
//        AppContext.getInstance().setSubscribeBagNo(String.format("%d", no));
//        LocalBroadcastManager.getInstance(context).sendBroadcast(new Intent(Constants.INTENT_ACTION_SUBSCRIBE_BAG_NO_CHANGED));
//    }
//
//    public static void notifyBagCartNoChanged(final Context context)
//    {
//        CartRequestData.listMonthlyCart(new RequestFinishHandler<ResultCart<ArrayList<SubscribeCartItem>>>() {
//            @Override
//            public void onRequestFinish(ResultCart<ArrayList<SubscribeCartItem>> data) {
//                if (data.OK()) {
//                    notifyBagCartNoChanged(context, data.getCnt());
//                }
//            }
//        });
//    }

    public static void notifyNetworkStatusChanged(final Context context)
    {
        boolean isConnected =  NetworkProber.checkNet(context);
//        if (AppContext.getInstance().isNetworkConnected() == isConnected)
        {
            AppContext.getInstance().setNetworkConnected(isConnected);
            LocalBroadcastManager.getInstance(context).sendBroadcast(new Intent(Constants.INTENT_ACTION_NETWORK_STATUS_CHANGED));
        }
    }
}

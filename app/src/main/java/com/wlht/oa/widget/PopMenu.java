...
public class PopMenu {
    ...
    public void show() {
        ...
        mCloseIv.startAnimation(animation);
    ...
    private void buildAnimateGridLayout() {
        ...
        mStatusBarHeight= dp2px(mActivity,24);
        FrameLayout.LayoutParams params = new FrameLayout.LayoutParams(mScreenWidth,mScreenHeight - mStatusBarHeight);
        params.topMargin = mStatusBarHeight;
        mAnimateLayout.setLayoutParams(params);
...
//        mCloseIv.setScaleType(ImageView.ScaleType.CENTER_INSIDE);
        mCloseIv.setImageResource(R.drawable.main_add_bg_open);
        ...
        int wh = dp2px(mActivity,46);
//        (int)mActivity.getResources().getDimension(R.dimen.oa_main_bottom_height);
        FrameLayout.LayoutParams layoutParams =
                new FrameLayout.LayoutParams(
                wh,
                wh, Gravity.BOTTOM | Gravity.CENTER_HORIZONTAL);
        layoutParams.bottomMargin = dp2px(mActivity, 4);

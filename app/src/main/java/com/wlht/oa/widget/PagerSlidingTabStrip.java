		...
		if (attrs != null) {
			...
			if (attrsTypedArray != null) {
				...
				disableViewPager = attrsTypedArray.getBoolean(
						...
						false);
				dividerColor = attrsTypedArray.getColor(R.styleable.PagerSlidingTabStrip_dividerColor, dividerColor);
				dividerPadding = attrsTypedArray.getDimensionPixelSize(R.styleable.PagerSlidingTabStrip_pstDividerPadding, dividerPadding);
